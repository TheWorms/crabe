...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const view = await remoteBrowser.manager().start({
      ...
      // (Shopify héberge les comptes clients sur shopify.com) : un renvoi VERS
      // ce domaine est la preuve, là où le lot 68 refuserait tout renvoi hors
      // site. Mesuré sur Atma le 08/09/2026.
      domaineEspaceClient: remoteLogin.domaineEspaceClient || '',
