...
const SERVICES = [
  ...
  // SEPIG est sorti de l'annonce au lot 73 : il devient une ébauche installable
  // (server/connectors/available/sepig/), d'où son retrait de cette table — la
  // relancer ne doit pas recréer son annonce par-dessus le connecteur.
  ...
  // --- Services publics ----------------------------------------------------
  //
  // ⚠ CAF n'est PAS listé ici, et ce n'est pas un oubli : désactivé au lot 78
  // (le portail a changé, voir planned/caf/manifest.json), son manifeste
  // annoncé est écrit À LA MAIN et porte toute la mesure du lot 77 — une
  // ligne ici l'écraserait à la première régénération, comme pour Envato.
  {
    id: 'france-travail',
    name: 'France Travail',
    category: 'public',
  ...
  // AutoDoc est devenu un connecteur réel au lot 79 : entrée purgée (même
  // geste). Son annonce portait d'ailleurs un domaine mort (www.autodoc.fr,
  // erreur SSL mesurée le 09/09/2026) — le vrai site est www.auto-doc.fr.
  {
  ...
  // Uber est devenu un connecteur réel (ébauche) au lot 72 : son dossier vit
  // sous available/ avec son connector.js. Entrée purgée pour qu'une
  // régénération ne recrée pas l'annonce par-dessus (piège Materiel.net,
  // lot 30 — même geste qu'Airbnb au lot 71).
  // Coyote est devenu un connecteur réel au lot 79 : entrée purgée pour
  // qu'une régénération ne recrée pas l'annonce par-dessus (piège
  // Materiel.net, lot 30).
