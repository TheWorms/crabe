...
test(
  ...
  async () => {
    ...
    try {
      ...
      // Le motif attendu ici était « ne montre plus de compte connecté » —
      // une citation du journal du 11/08/2026, conservée en commentaire dans
      // preuve-connexion.js, que le code n'écrit plus (lot 81). La phrase
      // actuelle dit la même chose en nommant l'adresse visée.
      assert.ok(
        j.contient(/renvoie au formulaire\s+de connexion/i),
