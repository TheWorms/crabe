...
const CONNECTORS = [
  ...
  // ⚠ CAF et Ameli ne sont PLUS générés ici, et ce n'est pas un oubli :
  //   - CAF est un service ANNONCÉ depuis le lot 78 (planned/caf/, manifeste
  //     écrit à la main — le portail a changé, voir sa note technique) ;
  //   - Ameli est réécrit à la main au lot 78 (session par la fenêtre,
  //     discover + multiselect) : le régénérer recréerait l'ancien parcours
  //     par identifiants, mort sur le code à usage unique.
  // Les remettre dans cette table écraserait ces fichiers au prochain passage.
  {
    id: 'amazon',
    name: 'Amazon',
    category: 'shopping',
