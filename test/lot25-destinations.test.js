...
test('kDrive compose son adresse WebDAV à partir du seul numéro', () => {
  // Forme mesurée le 09/09/2026 dans la documentation Infomaniak (FAQ 2409 et
  // 2405) : le numéro dans le nom d'hôte, AUCUN chemin derrière — l'ancien
  // suffixe « /<numéro> » (lot 24) ne figure plus dans aucune page.
  assert.equal(
  ...
  assert.equal(
    ...
    'https://12evil.connect.kdrive.infomaniak.com'
  );
});
